              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="{{ asset('assets/admin/') }}/img/users/user-1.png" class="user-img mr-2" alt="">
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="{{ asset('assets/admin/') }}/img/users/user-2.png" class="user-img mr-2" alt="">
                    <div class="media-body ml-3">
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="{{ asset('assets/admin/') }}/img/users/user-3.png" class="user-img mr-2" alt="">
                    <div class="media-body ml-3">
                  ...
                  <div class="support-ticket media pb-1 mb-3">
                    <img src="{{ asset('assets/admin/') }}/img/users/user-6.png" class="user-img mr-2" alt="">
                    <div class="media-body ml-3">
