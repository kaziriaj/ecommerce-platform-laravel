...
<main class="main">
            ...
            <div class="container">
                ...
                <div class="cat-blocks-container">
                    <div class="row">
                        @foreach ($homeCategory as $homeCate)
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="{{ route('category.products', $homeCate->id) }}" class="cat-block">
                                <figure>
                                    <span>
                                        <img src="{{ asset('storage/category/' . $homeCate->image) }}" alt="{{ $homeCate->name }}">
                                    </span>
                                </figure>

                                <h3 class="cat-block-title">{{ $homeCate->name }}</h3><!-- End .cat-block-title -->
                            </a>
            ...
            <div class="container">
                <div class="cta cta-border mb-5" style="background-image: url({{ asset('assets/frontend') }}/assets/images/demos/demo-4/bg-1.jpg);">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('{{ asset('assets/frontend') }}/assets/images/demos/demo-4/deal/bg-1.jpg');">
                            <div class="deal-top">
                    ...
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('{{ asset('assets/frontend') }}/assets/images/demos/demo-4/deal/bg-2.jpg');">
                            <div class="deal-top">
